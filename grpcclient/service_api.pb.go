...
func (*EmitEventRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_api_a7deeda6bf610ebd, []int{0}
}
...
func (*EmitEventReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_api_a7deeda6bf610ebd, []int{1}
}
...
func (*ListenTaskRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_api_a7deeda6bf610ebd, []int{2}
}
...
func (*TaskData) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_api_a7deeda6bf610ebd, []int{3}
}
...
func (*SubmitResultRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_api_a7deeda6bf610ebd, []int{4}
}
...
func (*SubmitResultReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_api_a7deeda6bf610ebd, []int{5}
}
...
func init() {
	proto.RegisterType((*EmitEventRequest)(nil), "grpcclient.EmitEventRequest")
	proto.RegisterType((*EmitEventReply)(nil), "grpcclient.EmitEventReply")
	proto.RegisterType((*ListenTaskRequest)(nil), "grpcclient.ListenTaskRequest")
	proto.RegisterType((*TaskData)(nil), "grpcclient.TaskData")
	proto.RegisterType((*SubmitResultRequest)(nil), "grpcclient.SubmitResultRequest")
	proto.RegisterType((*SubmitResultReply)(nil), "grpcclient.SubmitResultReply")
}
...
func (c *serviceClient) EmitEvent(ctx context.Context, in *EmitEventRequest, opts ...grpc.CallOption) (*EmitEventReply, error) {
	...
	err := c.cc.Invoke(ctx, "/grpcclient.Service/EmitEvent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) ListenTask(ctx context.Context, in *ListenTaskRequest, opts ...grpc.CallOption) (Service_ListenTaskClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Service_serviceDesc.Streams[0], "/grpcclient.Service/ListenTask", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *serviceClient) SubmitResult(ctx context.Context, in *SubmitResultRequest, opts ...grpc.CallOption) (*SubmitResultReply, error) {
	...
	err := c.cc.Invoke(ctx, "/grpcclient.Service/SubmitResult", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Service_EmitEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpcclient.Service/EmitEvent",
	}
...
func _Service_SubmitResult_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpcclient.Service/SubmitResult",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Service_serviceDesc = grpc.ServiceDesc{
	ServiceName: "grpcclient.Service",
...
func init() { proto.RegisterFile("service_api.proto", fileDescriptor_service_api_a7deeda6bf610ebd) }

var fileDescriptor_service_api_a7deeda6bf610ebd = []byte{
	// 312 bytes of a gzipped FileDescriptorProto
	,
}
